...
const CONFIG = {
  // 接口配置
  API: {
    HOST: "https://zy.jinchancaiji.com",
    VOD: "https://zy.jinchancaiji.com/api.php/provide/vod",
