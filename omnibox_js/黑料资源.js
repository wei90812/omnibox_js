...
const CONFIG = {
  // 接口配置
  API: {
    HOST: "https://www.heiliaozyapi.com",
    VOD: "https://www.heiliaozyapi.com/api.php/provide/vod",
