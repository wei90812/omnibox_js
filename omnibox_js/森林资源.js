...
const CONFIG = {
  // 接口配置
  API: {
    HOST: "https://beiyong.slapibf.com",
    VOD: "https://beiyong.slapibf.com/api.php/provide/vod",
