...
const CONFIG = {
  // 接口配置
  API: {
    HOST: "https://caiji.kuaichezy.org",
    VOD: "https://caiji.kuaichezy.org/api.php/provide/vod",
