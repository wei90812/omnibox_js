...
const CONFIG = {
  // 接口配置
  API: {
    HOST: "https://caiji.dyttzyapi.com",
    VOD: "https://caiji.dyttzyapi.com/api.php/provide/vod",
